...
void loop() {
  Blynk.run(); // Needed to keep Blynk methods running
...
// Capacity check to prevent wrong values
void checkCapacity(){
...
// Send current value of persons in a room to Blynk server
void sendCurrentIn() {
